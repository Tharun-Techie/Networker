...
// NOTE: each block MATCHes by id first — cypher-shell does not carry
// variables across statements, so bare MERGEs would spawn duplicate nodes.
MATCH (chandra:Person {id: 'person-n-chandrasekaran'}), (tcs:Organization {id: 'org-tcs'})
...
MATCH (chandra:Person {id: 'person-n-chandrasekaran'}), (sons:Organization {id: 'org-tata-sons'})
...
MATCH (chandra:Person {id: 'person-n-chandrasekaran'}), (motors:Organization {id: 'org-tata-motors'})
...
MATCH (chandra:Person {id: 'person-n-chandrasekaran'}), (steel:Organization {id: 'org-tata-steel'})
...
MATCH (ratan:Person {id: 'person-ratan-tata'}), (sons:Organization {id: 'org-tata-sons'})
