...
import { NODE_TYPES, REL_CATEGORIES, REL_TYPES } from "@networker/shared";

export { NODE_TYPES, REL_TYPES, REL_CATEGORIES };
    ...
    <div className="side-stack">
      ...
      <div className="card">
        ...
        <div className="row wrap">
          ...
          <button type="button" className="chip" onClick={() => setRel([])}>
            clear
          </button>
        </div>
        <div className="mt">
